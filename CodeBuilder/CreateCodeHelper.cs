...
namespace CodeBuilderPlus
{
    ...
    public class CreateCodeHelper
    {
        ...
        {
              //public class Hlt_CardInfoDAL : BaseDALConf<SqlConnection, SqlParameter, SqlServerHelper>, IBaseDAL<Hlt_CardInfo>
            StringBuilder sb = new StringBuilder();
        ...
        {
            //using ParkingJoyMall.Data.IDAL.Bases;
            //using ParkingJoyMall.Data.Models;
            //using System;
            //using System.Collections.Generic;
            //using System.Data;
        ...
        //public Hlt_CardInfo ToModel(DataRow row) { return GenericSQLGenerator.ToModel<Hlt_CardInfo>(row); }
        ...
        //    IEnumerable<Hlt_CardInfo> IBaseDAL< Hlt_CardInfo >.ListAll()
        //{
        //        DataTable dt = SqlHelper.ExecuteDataTable("SELECT [id], [cardNo], [custId], [cardStatus], [fkCardNo], [fkId], [validDate], [quotaType], [quotaCnt], [quota], [quickPassType], [quickPassCnt], [quickPass], [property], [createtime], [createuser], [modifytime], [modifyuser] FROM [Hlt_CardInfo];");
        //        return Helper.GenericSQLGenerator.ToList<Hlt_CardInfo>(dt);
        //    }
        ...
        {
            //object IBaseDAL< Hlt_CardInfo >.Insert(Hlt_CardInfo model)
            string[] colNames = GetColumnNames(dt);
        ...
        {
            //bool IBaseDAL< Hlt_CardInfo >.Update(Hlt_CardInfo model)
            sb.AppendLine(hasNamespace + "    /// <summary>");
        ...
        {
            //Hlt_CardInfo IBaseDAL< Hlt_CardInfo >.GetById(System.String id)
            string helper = sqltype == 2 ? "MySql" : "Sql";
            string heP = helper;
            sb.AppendLine(hasNamespace + "    /// <summary>");
        ...
        {
            //bool IBaseDAL< Hlt_CardInfo >.DeleteById(string id)
            string helper = sqltype == 2 ? "MySql" : "Sql";
            string heP = helper;
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.AppendLine("using IDAL.Bases;");
            sb.AppendLine("using Models;");
            sb.AppendLine("namespace IDAL");
            sb.AppendLine("{");
        ...
        {
            //public IEnumerable<Hlt_CardInfo> ListByPage(int page = 1, int num = 10, string orderBy = "id", bool isDesc = true, params string[] whereArr)
            sb.AppendLine(hasNamespace + "    /// <summary>");
        ...
        {
            //IEnumerable<Hlt_CardInfo> IBaseDAL< Hlt_CardInfo >.ListByWhere(Hlt_CardInfo model, string whereStr, params string[] fields)
            sb.AppendLine(hasNamespace + "    /// <summary>");
